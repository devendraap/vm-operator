...
// +kubebuilder:webhook:verbs=create;update,admissionReviewVersions=v1,sideEffects=none,path=/validate-operator-victoriametrics-com-v1beta1-vmalertmanager,mutating=false,failurePolicy=fail,groups=operator.acceldata.io,resources=vmalertmanagers,versions=v1beta1,name=vvmalertmanager.kb.io
