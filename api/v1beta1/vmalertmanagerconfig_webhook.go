...
// +kubebuilder:webhook:verbs=create;update,admissionReviewVersions=v1,sideEffects=none,path=/validate-operator-victoriametrics-com-v1beta1-vmalertmanagerconfig,mutating=false,failurePolicy=fail,groups=operator.acceldata.io,resources=vmalertmanagerconfigs,versions=v1beta1,name=vvmalertmanagerconfig.kb.io
