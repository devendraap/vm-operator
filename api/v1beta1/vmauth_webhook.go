...
// +kubebuilder:webhook:verbs=create;update,admissionReviewVersions=v1,sideEffects=none,path=/validate-operator-victoriametrics-com-v1beta1-vmauth,mutating=false,failurePolicy=fail,groups=operator.acceldata.io,resources=vmauths,versions=v1beta1,name=vvmauth.kb.io
