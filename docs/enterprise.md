...
[enterprise features for VictoriaMetrics components](https://docs.acceldata.io/enterprise.html):
...
on [VictoriaMetrics Enterprise page](https://docs.acceldata.io/enterprise.html#victoriametrics-enterprise-features).

In order to find examples of deploying enterprise components with operator,
please, check [this](https://docs.acceldata.io/enterprise.html#kubernetes-operator) documentation.
